  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [catRes, deptRes, brandRes, unitRes, warrantyRes, varRes, printerRes, itemRes, modRes] = await Promise.all([
        ...
        if (itemRes.ok) {
          ...
          setFormData({
            ...
            manage_stock: itemData.manage_stock || false,
            ...
            is_require_printing: itemData.is_require_printing !== false,
            printer_location: itemData.printer_location || '',
            is_show_kitchen_monitor: itemData.is_show_kitchen_monitor !== false,
            image: itemData.image || ''
          });

          setHasImage(Boolean(itemData.image));
          ...
          if (itemData.modifier_groups) {
            setSelectedModifierGroupIds(itemData.modifier_groups.map((mg: any) => mg.modifier_group_id));
          }
        }
      } catch (err) {
    ...
    <div className="h-full overflow-y-auto w-full">
      <div className="p-8 max-w-5xl mx-auto pb-24">
        ...
        <form onSubmit={handleSave} className="space-y-8">
                    ...
                    <table className="w-full text-left text-text-main">
                      ...
                      <tbody>
                        {generatedVariations.map((v, idx) => (
                          <tr key={idx} className="border-b border-border last:border-0 hover:bg-surface-light">
          ...
          {/* Section 5: Printer & Kitchen Display Options */}
          <div className="glass rounded-3xl p-8 border border-border">
