  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [catRes, brandRes, unitRes, warrRes, varRes] = await Promise.all([
    ...
    <div className="p-8 max-w-5xl mx-auto pb-24">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="glass rounded-3xl p-8 border border-white/10">
          <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4">General Information</h2>
                  ...
                  <table className="w-full text-left text-white">
                    <thead>
                      <tr className="border-b border-white/10">
                        <th className="py-2 text-sm text-text-muted">Pilihan</th>
                        <th className="py-2 text-sm text-text-muted">SKU</th>
                        <th className="py-2 text-sm text-text-muted">Harga Jual</th>
                        <th className="py-2 text-sm text-text-muted">Stok</th>
                      </tr>
                    </thead>
                    <tbody>
        ...
        {formData.type === 'single' && (
          <div className="glass rounded-3xl p-8 border border-white/10">
            <h2 className="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-4">Harga & Stok</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
